package br.com.wallacysebastian.fullstackweek.resources;
...
import br.com.wallacysebastian.fullstackweek.repository.GruposPrioridadesRepository;
...
public class GruposPrioridadesResource {
	...
	@PostMapping
	public GruposPrioridades cadastrarGruposPrioridades(@RequestBody GruposPrioridades gruposPrioridades) {
		return gruposPrioridadesRepository.save(gruposPrioridades);
	}
	
	@PutMapping("{codigo}")
	public GruposPrioridades atualizar(@PathVariable("codigo") Long codigo,
